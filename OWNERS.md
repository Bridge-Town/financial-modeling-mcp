...
This file is generated from `directory-resources.v1.json`. Resource IDs,
versions, owners, and links are release metadata; changes require review by
the listed owner.

| Resource | Version | Owner | Canonical link |
| --- | --- | --- | --- |
| `connector-package` | `1.0.1` | `team/platform-engineering` | <https://github.com/Bridge-Town/financial-modeling-mcp> |
